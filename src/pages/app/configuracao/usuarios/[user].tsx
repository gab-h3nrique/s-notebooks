      ...
      <Layout page={'configuracao'}>
        ...
        <section className="">
          ...
          <article className="flex w-full justify-start gap-4">
            ...
            <div className="hidden relative items-center justify-center bg-slate-100 rounded-2xl w-fit p-1 px-3 gap-2 border-solid border-[.2rem] border-white duration-150 group cursor-pointer">
