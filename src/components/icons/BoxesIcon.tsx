...
export default function BoxesIcon(props: React.SVGProps<SVGSVGElement>) {

    return (
        <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className={`${props.className}`}>
