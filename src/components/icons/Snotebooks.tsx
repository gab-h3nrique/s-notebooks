...
const Snotebooks = (props: React.SVGProps<SVGSVGElement>) => {

    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" viewBox="0 0 384 512" {...props}>
            ...
            stroke={`${props.stroke}`} strokeWidth={`${props.strokeWidth}`}  fillRule="evenodd"
            />
        </svg>
    )
}

export default Snotebooks
